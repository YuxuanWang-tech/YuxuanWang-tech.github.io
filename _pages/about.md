...
title: about
permalink: /
subtitle: Ph.D. Candidate in Computational & Applied Physics @ UPC

profile:
  align: right
  image: prof_pic.jpg # 记得把照片改名传到 assets/img/prof_pic.jpg
  image_circular: false # 如果想要圆头像改为 true
  more_info: >
    <p>Barcelona, Spain</p>
    <p>yuxuan.wang2@upc.edu</p>

selected_papers: true # 暂时没有发表文章可以设为 false
social: true # 显示你在 _config.yml 配置的社交图标
...
* **Signal Processing:** High-frequency time-series analysis, RFI mitigation.
* **Machine Learning:** Rare signal extraction using PyTorch and TensorFlow.
* **Quantitative Modeling:** Monte Carlo optimization and stochastic system analysis.
